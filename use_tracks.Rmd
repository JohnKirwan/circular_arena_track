...
get_trial_limits <- function(landmarks,animal_track,file_tbl,vid_num){ #,
 ...
 trial_limits <- as_tibble(array(0,dim=c(num_trials,16),
    ...
    "last_f","norm_stim_x","norm_stim_y","theta","rho","quadrant","video",
...
# trackz_transform <- function(all_trackz,trial_limits){
# 
#  num_trials = dim(trial_limits)[1] # count number of trials
#  pre_tranz_trackz = all_trackz 
#  i = 1
#  while(i <= length(all_trackz)) {     # for each tibble in the list
# 
...
```{r}
linecirc(trial_limits[1,13],trial_limits[1,14],trial_limits[1,15],trial_limits[1,16])
```
